...
fit_classifiers <- function (summary_AUTO){
  ...
  to_remove      <- names(summary_AUTO)[which(missing_hits>5|missing_misses>5)] ##remove all variables that have more than 5% missing cases in both minority class and majority class

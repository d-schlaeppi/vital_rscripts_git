...
interaction_detection <- function (e
  ...
  collisions <- all_collisions; rm(list=c("all_collisions"));gc()
  #######################################
  ...
  # interactions       <- interactions[order(interactions$start,interactions$end,interactions$ant1,interactions$ant2),]

...
only_files <- all_items[!file.info(all_items)$isdir]
interac_list <- c(interac_list, file.path(input_path2, only_files))


to_keep <- c(ls(),"to_keep","i","interac")
for (i in 98:100){#####perform 100 randomisations

  ...
  for (ant in   1: length(e$ants)) {
    AntID_list <- rbind(AntID_list,
                        data.frame (
                          ...
                          ,
                          alive = e$ants[[ant]]$getValue("dead",fmTimeNow())
                          ,
                          CHALL_BB = e$ants[[ant]]$getValue("CHALL_BB",fmTimeNow())
                          ,
                          CHALL_KVL = e$ants[[ant]]$getValue("CHALL_KVL",fmTimeNow())
                          ,
                          CHALL_BLUE = e$ants[[ant]]$getValue("CHALL_BLUE",fmTimeNow())
                          ,
                          CHALL_YELLOW = e$ants[[ant]]$getValue("CHALL_YELLOW",fmTimeNow())
                          ,
                          SIBB = e$ants[[ant]]$getValue("SIBB",fmTimeNow())
                          ,
                          SIKVL = e$ants[[ant]]$getValue("SIKVL",fmTimeNow())
                          ,
                          SISH = e$ants[[ant]]$getValue("SISH",fmTimeNow())
                        ))
  }

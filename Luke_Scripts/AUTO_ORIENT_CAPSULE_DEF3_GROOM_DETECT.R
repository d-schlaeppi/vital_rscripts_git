...
ref_orient_caps_file <-  EXP_list[which(grepl(EXP_list$path_name,pattern = "CapsuleDef3.myrmidon")),]
 ...
 #     REP.filefolder  <- paste(REP.folder,variable,sep="/")
   #   REP.dir <- dir_file(ToOrient_myr_file)
     # tracking_data$save(paste0(REP.dir),"_AutoOriented.myrmidon")
      tracking_data$save(paste0(sub("\\..*", "", ToOrient_myr_file),"_AutoOriented_CAPSULEDEF3.myrmidon"))

...
sourceCpp("/media/cf19810/SeagateDesktopDrive/SICC_ANALYSIS/Get_Movement_Angle.cpp")
...
ref_orient_caps_file <-  EXP_list[which(grepl(EXP_list$path_name,pattern = "CapsuleDef3_GROOM_DETECTION.myrmidon")),]
...
ToOrient_file <- EXP_list[which(grepl(EXP_list$path_name,pattern = "_AutoOriented_withMetaData_QUEEN")),]
ToOrient_file_path <- ToOrient_file$path_name
ToOrient_file <- EXP_list[which(grepl(EXP_list$path_name,pattern = "EXP_11P_V31_270422_HDN_MAIN_KEY_DEATHS_AutoOriented_withMetaData_QUEEN.my")),]
ToOrient_file_path <- '/media/cf19810/SeagateDesktopDrive/SICC_DATA/11P_V31_270422_HDN/EXP_11P_V31_270422_HDN_MAIN_KEY_DEATHS_AutoOriented_withMetaData_QUEEN.myrmidon'
ToAssignCapDef <- NULL
...
#    data_list         <- ref_orient_caps_file[which( grepl(CAPSULEDEF,ref_orient_caps_file$path_name) & ref_orient_caps_file$REP_treat_name ==REP_TREAT_NAME),"path_name"]
  ...
  for (ToOrient_myr_file in ToOrient_data_list){
    ...
    ToOrient_data$save(paste0(sub("\\..*", "", ToOrient_myr_file),"_CapsuleDef3.myrmidon"))
    
    print(paste("Saving ",ToOrient_exp_name, " as ",TS,"_CapsuleDef3.myrmidon",sep =""))

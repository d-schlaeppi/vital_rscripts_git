...
defined_capsule_file <- paste("/media/ll16598/SeagateDesktopDrive/ADRIANO_CAPSULES/CURRENT_CAPS_DEF_BASE_FILES_MAN_ORIENTED/CapsuleDef2018_R3SP_ManualOriented_base.myrmidon",sep='') #prideaux
...
no_capsule_list <- list(
  ...
  paste(dir_data,"13P_IV31_110522_HDN/13P_IV31_110522_HDN_manual_orient_no_capsule.myrmidon",sep=''), 
  paste(dir_data,"14P_IV20_170522_LEA/14P_IV20_170522_LEA_manual_orient.myrmidon",sep='')) 

#create output folder
output_name <- file.path(paste0('/media/ll16598/SeagateDesktopDrive/', "Mean_ant_length_colonies_CHECK.txt")) # (saved INSIDE the Network_analysis folder)
...
for (no_capsule_file in no_capsule_list) {
  ...
  tracking_data$save(paste0(sub("\\..*", "", no_capsule_file),"_STROEYM.myrmidon"))
